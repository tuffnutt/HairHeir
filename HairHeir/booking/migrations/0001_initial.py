# Generated by Django 2.1.2 on 2018-11-29 05:50
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='District',
            fields=[
                ('province', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='booking.Province')),
                ('name', models.CharField(max_length=50)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.ManyToManyField(to='booking.Type')),
            ],
        ),
        migrations.AddField(
            model_name='gallery',
        ...
        migrations.CreateModel(
            name='City',
            fields=[
                ('province', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='booking.District')),
                ('name', models.CharField(max_length=50)),
            ],
        ),
        migrations.AddField(
